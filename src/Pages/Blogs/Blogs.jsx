        ...
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body className="text-muted">
            ...
            <p>
              ...
              holds the pet food. The person may not have permission to go into
              the bedroom for a quick nap.
            </p>
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            <p>
              ...
              grow and make us marketing strategies. And that is totally free.We
              can easily identify the issues with our app that are related to
              the users that come and visit your app.We can set different values
              for different OS versions, region, app version, and a lot more. If
              you haven’t given it a try, then I would highly urge you to
              explore this fantastic product and check out how you can implement
              ant benefit from it.
            </p>
            <p>
